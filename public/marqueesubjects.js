...
const getSubjects = localStorage.getItem('subjects');
            ...
            // {myQuestions[totalquestion].class
...
function buildQuiz(){
    ...
    if (fromNumber > 1) {
        ...
        string += `<div id="id3" onclick="press('${myQuestions[totalquestion].address}')" class="subjectBox modclass" style="visibility:;">
        <div class="${myQuestions[totalquestion].class}" onclick="" style="font-size:;background-color:;margin:20px 0px 0px 0px;"></div>
                <div style="background-color:;font-size:px;margin:10px 5px 0px 5px;">${myQuestions[totalquestion].name} </div>
                </div>`;
        totalquestion = totalquestion - 1;
        string += `<div id="id3" onclick="press('${myQuestions[totalquestion].address}')" class="subjectBox modclass" style="visibility:;">
        <div class="${myQuestions[totalquestion].class}" onclick="" style="font-size:;background-color:;margin:20px 0px 0px 0px;"></div>
    ...
    string2 += `<div id="id3" onclick="press2('${subjectsCards[totalquestion2].subject}','${subjectsCards[totalquestion2]._id}','${subjectsCards[totalquestion2].author}','${totalquestion2}')" class="subjectBox modclass" style="visibility:;">
        ...
        <div class="marqueeContainerHorizontal marqueeContainer highlightiy" data-direction="horizontal">
          <div style="margin : 0 auto;" class="marqueeTextHorizontal marqueeText">${subjectsCards[totalquestion2].subject.charAt(0).toUpperCase()+subjectsCards[totalquestion2].subject.slice(1)} 
     ...
     string2 += ` <div class="marqueeMain" data-url="/page1.html" onclick="marqueeClick(this)" >
      <div class="marqueeContainerHorizontal marqueeContainer highlightiy" data-direction="horizontal">
        <div style="margin-left:50%;" class="marqueeTextHorizontal marqueeText">${subjectsCards[totalquestion2].branch},${subjectsCards[totalquestion2].semester}Semester,${subjectsCards[totalquestion2].degree} 
...
// }
    ...
    function press2(subject,subjectId,subAut, subAll){
      ...
      if(payload.designation == "teacher"){
        document.location = `/class.html`;

      }else if(payload.designation == "student"){
        document.location = `/subject.html`;

      }else{
        document.location = `/pageDoesNotExist.html`;

...
function buildQuiz(){
    ...
    string += `<div id="id3" onclick="press2('${myQuestions[totalquestion].address}')" class="subjectBox modclass" style="visibility:;">
    
    <div class="${myQuestions[totalquestion].class}" onclick="" style="font-size:;background-color:;margin:20px 0px 0px 0px;"></div>
            <div style="background-color:;font-size:px;margin:10px 0px 0px 0px;">${myQuestions[totalquestion].name} </div>
            </div>`;
    totalquestion = totalquestion - 1;
    string += `<div id="id3" onclick="press2('${myQuestions[totalquestion].address}')" class="subjectBox modclass" style="visibility:;">
    <div class="${myQuestions[totalquestion].class}" onclick="" style="font-size:;background-color:;margin:20px 0px 0px 0px;"></div>
    ...
    // string += `<div id="id2" onclick="press2('wwwww')" class="subjectBox modclass" style="visibility:;">
    ...
    <div style="background-color:;font-size:px;margin:10px 0px 0px 0px;">Empty</div>
    </div>`;
    }
    string += `</div></div>`;
    }
    ...
    string2 += `<div id="id3" onclick="press2('${myQuestions2a[totalquestion2].address}')" class="subjectBox modclass" style="visibility:;">
    
    <div  class="${myQuestions2a[totalquestion2].class}" onclick="" style="font-size:;background-color:;margin:20px 0px 0px 0px;"></div>
    <div style="background-color:;font-size:px;margin:10px 0px 0px 0px;">${myQuestions2a[totalquestion2].name} </div>
    ...
    // <div style="background-color:;font-size:px;margin:10px 0px 0px 0px;">Add Degree </div>
    // </div>`;
    string2 += `<div id="id2" onclick="press2xxx('wwwww')" class="subjectBox modclass" style="visibility:;">
            ...
            if(itemsData){
                ...
                if(found){
                    ...
                    if(found.attRegisFlag == true){
                        ...
                        document.location = `/attendance1.html`;
                    }
                }else{

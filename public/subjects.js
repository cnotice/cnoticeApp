...
function buildQuiz(){
    ...
    string2 += `<div id="id3" onclick="press2('${subjectsCards[totalquestion2].subject}','${subjectsCards[totalquestion2]._id}')" class="subjectBox modclass" style="visibility:;">
...
// }
        ...
        let nextButton2 = document.getElementById("next2");
         ...
         <div id="id3" onclick="" class="scoreBox modclass" style="visibility:;height:115px;padding:0px;">
    ...
    // function press2(rrr){
    function press2(subject,subjectId){
        // alert(subject);
        // alert(subjectId);
